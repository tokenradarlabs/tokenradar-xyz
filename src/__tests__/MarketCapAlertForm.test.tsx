...
describe("MarketCapAlertForm", () => {
  it("renders correctly with initial form state", () => {
    ...
    expect(screen.getByLabelText(/marketcap direction/i)).toHaveValue("rises_above");
    expect(screen.getByDisplayValue("1000")).toBeInTheDocument();
    expect(screen.getByText(/btc marketcap is currently \$1,234.56 billion/i)).toBeInTheDocument();
