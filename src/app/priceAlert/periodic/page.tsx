...
export default function PeriodicPage() {
  ...
  return (
    <div className='flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-800 via-[#aba6bb] to-[#d3ccea]'>
      <div className='w-full max-w-xl rounded-2xl border border-[#22243a] bg-[#181a22] p-10 shadow-2xl'>
        <h2 className='mb-8 text-center text-3xl font-bold tracking-tight text-purple-200'>
