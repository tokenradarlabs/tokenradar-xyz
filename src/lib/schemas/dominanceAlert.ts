...
export const dominanceAlertSchema = z.object({
  threshold: z.coerce.number().min(0, { message: 'Threshold must be a non-negative number.' }).max(100, { message: 'Threshold cannot exceed 100.' }),
